...
export default function LandingPage() {
  useEffect(() => {
    ...
    link1.href = "https://fonts.googleapis.com/css2?family=Noto+Serif:ital,wght@0,400;0,700;1,400&family=Inter:wght@400;500;600&family=Public+Sans:wght@300;400;600&family=Material+Symbols+Outlined:wght,FILL@100..700,0..1&display=swap";
      ...
      <section className="pt-32 pb-20 px-8 max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative">
            ...
            {/* Floating Glass Card */}
            <div className="absolute -bottom-10 -left-10 bg-white/80 backdrop-blur-2xl p-6 rounded-2xl border border-white/20 shadow-xl max-w-xs">
              <div className="flex items-center gap-4 mb-4">
                <div className="w-12 h-12 rounded-full bg-primary-fixed flex items-center justify-center">
                  <span className="material-symbols-outlined text-primary" data-icon="auto_awesome">auto_awesome</span>
                </div>
                <div>
                  <p className="mono-label text-[10px] uppercase text-slate-500">AI Status</p>
            ...
            <div className="flex flex-col md:flex-row-reverse items-center gap-16">
              ...
              <div className="w-full md:w-1/2">
                ...
                <div className="flex gap-4">
                  ...
                  <span className="px-4 py-2 bg-white rounded-full text-xs mono-label text-slate-500 uppercase">Management</span>
                </div>
              </div>
            </div>
            {/* Step 03 */}
          ...
          <div className="bg-slate-100 dark:bg-slate-800-low p-10 rounded-2xl flex flex-col justify-between">
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-[10px] mono-label text-slate-500 uppercase tracking-tighter">Senior Lead @ Fintech</p>
              </div>
            </div>
          </div>
          {/* Testimonial 2 */}
          <div className="bg-slate-100 dark:bg-slate-800-high p-10 rounded-2xl flex flex-col justify-between">
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-[10px] mono-label text-slate-500 uppercase tracking-tighter">Director of Operations</p>
              </div>
            </div>
          </div>
          {/* Testimonial 3 */}
          <div className="bg-slate-100 dark:bg-slate-800-low p-10 rounded-2xl flex flex-col justify-between">
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-[10px] mono-label text-slate-500 uppercase tracking-tighter">Freelance Art Director</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <footer className="bg-slate-50 dark:bg-slate-950 w-full border-t border-slate-200/15">
        <div className="flex flex-col md:flex-row justify-between items-center px-12 py-16 w-full max-w-7xl mx-auto">
          <div className="mb-8 md:mb-0">
            <div className="text-xl font-serif italic text-blue-900 dark:text-blue-100 mb-4">LearnLaunch</div>
            <p className="text-slate-500 text-sm max-w-xs">© 2024 LearnLaunch. Archival quality career curation.</p>
          </div>
          <div className="flex flex-wrap gap-x-12 gap-y-6 justify-center">
            <a className="text-slate-500 hover:underline decoration-blue-500/50 mono-label text-xs uppercase tracking-widest" href="#">Privacy Policy</a>
            <a className="text-slate-500 hover:underline decoration-blue-500/50 mono-label text-xs uppercase tracking-widest" href="#">Terms of Service</a>
            <a className="text-slate-500 hover:underline decoration-blue-500/50 mono-label text-xs uppercase tracking-widest" href="#">AI Ethics</a>
            <a className="text-slate-500 hover:underline decoration-blue-500/50 mono-label text-xs uppercase tracking-widest" href="#">Contact Us</a>
          </div>
        </div>
      </footer>
